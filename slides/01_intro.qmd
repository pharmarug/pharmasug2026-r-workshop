...
::: columns
::: {.column width="70%"}
-   Master of Mathematics in Statistics from the University of Waterloo, Canada 
-   Principal Analytical Data Scientist at Roche; over 10 years of drug development experience; led multiple global pivotal Phase 3 trial readouts and Health Authority submissions.
-   Active contributor to Roche internal R packages
-   Feel free to connect at [`r fontawesome::fa("github")` Github](https://github.com/w316liu "Wenyi Liu at GitHub")
:::
...
-   Course website at [pharmarug.github.io/pharmasug2026-r-workshop/](https://pharmarug.github.io/pharmasug2026-r-workshop/)
    -   all slides
    -   sources available at [github.com/pharmarug/pharmasug2026-r-workshop](https://github.com/pharmarug/pharmasug2026-r-workshop)
...
- The source files are hosted at [github.com/pharmarug/pharmasug2026-r-workshop]( https://github.com/pharmarug/pharmasug2026-r-workshop), which is forked from the original version at [github.com/openpharma/workshop-r-swe](https://github.com/openpharma/workshop-r-swe).
